...
<INPUT type="radio" name="mibotondeopcion" checked value="1">Estudiante<br/></INPUT>
<INPUT type="radio" name="mibotondeopcion" value="2">Astronauta<br/></INPUT>
<INPUT type="radio" name="mibotondeopcion" value="3">Médico<br/></INPUT>
<INPUT type="radio" name="mibotondeopcion" value="4">Webmaster<br></INPUT>
	...
	<div id="content">
		...
		<form action="ingreso.php" method="POST">
	        <table border="1">
		        ...
		        <tr>
		            <td><label><input type="submit" value="Registrarme"></label> </td>
